...
import { ArrowRight, Layers, LineChart, Target, Zap } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#fafcff] font-sans overflow-x-hidden selection:bg-emerald-500/30">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            The world's most advanced trading journal. Deep analytics, automatic
            AI insights, and playbook tracking built for elite traders.
          </motion.p>
            ...
            <div className="rounded-2xl border border-gray-200/50 bg-white p-4 shadow-2xl backdrop-blur-3xl overflow-hidden transform transition-all hover:scale-[1.01] duration-500 h-[400px] flex gap-4">
              ...
              <div className="w-64 bg-gray-50 rounded-xl border border-gray-100 hidden md:flex flex-col gap-2 p-4">
                ...
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="w-full h-6 bg-gray-100 rounded-md animate-pulse"
                  ></div>
                ))}
              </div>
      ...
      <section
        id="features"
        className="py-24 bg-white border-t border-gray-100 px-6"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 font-medium">
              Built by traders, for traders. No fluff, just actionable data.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div className="relative z-10">
                ...
                <p className="text-gray-500 font-medium max-w-sm">
                  Track your cumulative P&L, daily net, and win rates with
                  granular filtering by date, setup, and side.
                </p>
              </div>
              {/* Decorative Element */}
            ...
            >
              ...
              <p className="text-gray-500 font-medium">
                Automatic pattern recognition to spot your best and worst habits
                instantly.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-500 font-medium">
                Tag your trades by strategy (e.g. Breakout, VWAP Rejection) to
            ...
            >
              <div className="relative z-10">
                ...
                <p className="text-gray-500 font-medium max-w-sm">
                  Our proprietary algorithm analyzes your consistency,
                  risk-to-reward, and execution to give you a definitive rating
